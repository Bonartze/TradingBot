...
public:
    explicit ArimaGarchAdaptive(const std::vector<double> &data) : TradingStrategy({}, {def_balance}, "",
                                                                       "",
                                                                       ""),
    ...
    explicit ArimaGarchAdaptive(const std::string &data) : TradingStrategy({}, {def_balance, false, 0.0, 0.0, false},
                                                                           "", "",
                                                                           ""),
                                                           arima_model(std::make_unique<ARIMAModel>(data)) {
        garch_model = std::make_unique<GarchModel>(*arima_model);
