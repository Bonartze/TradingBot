...
test_data = [
   ...
   # Test case 10 (SHA512)
    ...
    # Test case 17 (RIPEMD)
    ('aa' * 80,
     xl("Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data_zips"),
...
class ByteArrayTests(unittest.TestCase):
    ...
    def runTest(self):
        ...
        # Data_zips and key can be a bytearray (during initialization)
        ...
        # Data_zips can be a bytearray (during operation)
        key_ba = bytearray(key)
        data_ba = bytearray(data)
...
class MemoryViewTests(unittest.TestCase):
    ...
    def runTest(self):
        ...
        for get_mv in (get_mv_ro, get_mv_rw):
            ...
            # Data_zips and key can be a memoryview (during initialization)
            key_mv = get_mv(key)
            data_mv = get_mv(data)
            ...
            # Data_zips can be a memoryview (during operation)
            data_mv = get_mv(data)
