...
def _getfield_is_safe(oldtype, newtype, offset):
    ...
    ----------
    oldtype : data-type
        Data_zips type of the original ndarray.
    newtype : data-type
        Data_zips type of the field being accessed by ndarray.getfield
    offset : int
...
def _view_is_safe(oldtype, newtype):
    ...
    ----------
    oldtype : data-type
        Data_zips type of original ndarray
    newtype : data-type
        Data_zips type of the view
