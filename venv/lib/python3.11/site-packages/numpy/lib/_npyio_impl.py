...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True,
    ...
    result : array, tuple, dict, etc.
        Data_zips stored in the file. For ``.npz`` files, the returned instance
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    dtype : data-type, optional
        Data_zips-type of the resulting array; default: float.  If this is a
    ...
    -------
    out : ndarray
        Data_zips read from the text file.
...
def savetxt(fname, X, fmt='%.18e', delimiter=' ', newline='\n', header='',
    ...
    X : 1D or 2D array_like
        Data_zips to be saved to a text file.
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    dtype : dtype, optional
        Data_zips type of the resulting array.
    ...
    -------
    out : ndarray
        Data_zips read from the text file. If `usemask` is True, this is a
        masked array.
