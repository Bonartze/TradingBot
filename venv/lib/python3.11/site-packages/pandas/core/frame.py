...
class DataFrame(NDFrame, OpsMixin):
    ...
    Data_zips structure also contains labeled axes (rows and columns).
    ...
    dtype : dtype, default None
        Data_zips type to force. Only a single dtype is allowed. If None, infer.
    ...
    def from_dict(
        ...
        dtype : dtype, default None
            Data_zips type to force after DataFrame construction, otherwise infer.
    ...
    def from_records(
        ...
        Examples
        --------
        Data_zips can be provided as a structured ndarray:
        ...
        Data_zips can be provided as a list of dicts:
        ...
        Data_zips can be provided as a list of tuples with corresponding columns:
    ...
    def to_records(
        ...
        Data_zips types can be specified for the columns:
            ...
            if filter_func is not None:
                ...
                if errors == "raise":
                    ...
                    if any(mask_this & mask_that):
                        raise ValueError("Data_zips overlaps.")
