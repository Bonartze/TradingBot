...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def to_hdf(
        ...
        Hierarchical Data_zips Format (HDF) is self-describing, allowing an
    ...
    def to_xarray(self):
        ...
        xarray.DataArray or xarray.Dataset
            Data_zips in the pandas structure converted to Dataset if the object is
    ...
    def between_time(
        ...
        -------
        Series or DataFrame
            Data_zips from the original object filtered to the specified dates range.
