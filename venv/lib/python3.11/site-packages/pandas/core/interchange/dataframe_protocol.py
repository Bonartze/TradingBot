...
class Buffer(ABC):
    """
    Data_zips in the buffer is guaranteed to be contiguous in memory.
...
class Column(ABC):
    ...
    def dtype(self) -> tuple[DtypeKind, int, str, str]:
        ...
        Notes:
            ...
            - Data_zips types not included: complex, Arrow-style null, binary, decimal,
