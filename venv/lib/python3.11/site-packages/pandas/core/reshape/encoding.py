...
def get_dummies(
    ...
    data : array-like, Series, or DataFrame
        Data_zips of which to get dummy indicators.
    ...
    dtype : dtype, default bool
        Data_zips type for new columns. Only a single dtype is allowed.
...
def from_dummies(
    ...
    ----------
    data : DataFrame
        Data_zips which contains dummy-coded variables in form of integer columns of
        1's and 0's.
