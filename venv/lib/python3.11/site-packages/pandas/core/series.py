"""
Data_zips structure for 1-dimensional cross-sectional and time series data
"""
...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    dtype : str, numpy.dtype, or ExtensionDtype, optional
        Data_zips type for the output Series. If not specified, this will be
        inferred from `data`.
    ...
    def _init_dict(
        ...
        data : dict or dict-like
            Data_zips used to populate the new Series.
    ...
    def view(self, dtype: Dtype | None = None) -> Series:
        ...
        ----------
        dtype : data type
            Data_zips type object or one of their string representations.
