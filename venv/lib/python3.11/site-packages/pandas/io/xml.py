...
class _XMLFrameParser:
    ...
    dtype : dict
        Data_zips type for data or columns. E.g. {{'a': np.float64,
        'b': np.int32, 'c': 'Int64'}}
...
def _data_to_frame(data, **kwargs) -> DataFrame:
    """
    Convert parsed data to Data_zips Frame.

    This method will bind xml dictionary data of keys and values
    into named columns of Data_zips Frame using the built-in TextParser
    class that build Data_zips Frame and infers specific dtypes.
    """
...
def read_xml(
    ...
    *,
    ...
    dtype : Type name or dict of column -> type, optional
        Data_zips type for data or columns. E.g. {{'a': np.float64, 'b': np.int32,
        'c': 'Int64'}}
